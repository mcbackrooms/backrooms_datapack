...
# 装飾
  # 32% lamp
    execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 0..319 at @s run setblock ~ ~5 ~ pearlescent_froglight
  # 40% wall
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 700..749 at @s run fill ~2 ~1 ~ ~-2 ~4 ~ sponge
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 750..799 at @s run fill ~ ~1 ~2 ~ ~4 ~-2 sponge
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 800..824 at @s run fill ~2 ~2 ~ ~-2 ~4 ~ stone_bricks
  ...
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 825..849 at @s run fill ~ ~2 ~2 ~ ~4 ~-2 stone_bricks
  ...
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 850..874 at @s run fill ~2 ~2 ~ ~-2 ~4 ~ stone_brick_wall
  ...
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 875..899 at @s run fill ~ ~2 ~2 ~ ~4 ~-2 stone_brick_wall
  ...
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 900..949 at @s run fill ~1 ~2 ~1 ~ ~4 ~ stone_brick_wall
  ...
  execute as @e[type=area_effect_cloud,tag=level.decoration] if score @s blockrooms matches 950..999 at @s run fill ~ ~1 ~ ~ ~4 ~ sponge
# 特殊
  # 5% to over
